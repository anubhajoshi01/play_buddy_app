    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          IconButton(
            icon: Icon(Icons.home, size: 44.0, color: (division == Divisions.HOME) ? Colors.black : Colors.grey,),
            onPressed: () {
          ...
          //category screen
          IconButton(
            icon: Icon(Icons.search, size: 44.0, color: (division == Divisions.SEARCH) ? Colors.black : Colors.grey,),
            onPressed: () {
          ...
          IconButton(
            icon: Icon(Icons.people, size: 44.0, color: (division == Divisions.FRIENDS) ? Colors.black: Colors.grey,),
            onPressed: () {
          ...
          IconButton(
            icon: Icon(Icons.person, size: 44.0, color: (division == Divisions.PROFILE) ? Colors.black : Colors.grey,),
            onPressed: () {
