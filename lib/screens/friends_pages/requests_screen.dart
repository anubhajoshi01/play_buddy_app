        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              ListView.builder(itemCount: requestsSent.length,itemBuilder: (context, index){
                return Dismissible(
                  key: Key("$index"),
                  child: Card(
                    child: ListTile(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ProfileScreen(user: requestsSent[index])));
                  ...
                  onDismissed: (direction){
                    ...
                    Set<int> newRequestRecieved = requestsSent[index].requestReceivedList;
                    newRequestSentList.remove(thisUser.id);

                    UserDb.updateData(requestsSent[index].id, requestReceivedList: newRequestRecieved);
              ...
              ListView.builder(itemCount: requestsReceived.length,itemBuilder: (context, index){
                return Dismissible(
                  key: Key("$index"),
                  child: Card(
                    child: ListTile(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ProfileScreen(user: requestsReceived[index],)));
                  ...
                  onDismissed: (direction){
                    if(direction == DismissDirection.endToStart){
                      ...
                      newRequestRecievedList.remove(requestsReceived[index].id);
                       UserDb.updateData(thisUser.id, requestReceivedList: newRequestRecievedList, friendsUserIdList: newFriendList);

                      Set<int> newRequestSentList = requestsReceived[index].requestSentList;
                      Set<int> newFriendList2 = requestsReceived[index].friendsUserIdList;
                      newRequestSentList.remove(thisUser.id);
                      newFriendList2.add(thisUser.id);
                       UserDb.updateData(requestsReceived[index].id, requestSentList: newRequestSentList, friendsUserIdList: newFriendList2);
                      ...
                      Set<int> newRequestRecievedList = thisUser.requestReceivedList;
                      newRequestRecievedList.remove(requestsReceived[index].id);
                       UserDb.updateData(thisUser.id, requestReceivedList: newRequestRecievedList);

                      Set<int> newRequestSentList = requestsReceived[index].requestSentList;
                      newRequestSentList.remove(thisUser.id);
                       UserDb.updateData(requestsReceived[index].id, requestSentList: newRequestSentList);
